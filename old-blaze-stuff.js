...
Template.sChatBox.events({
  'click .js-chat-box-open': function (e, tmpl) {
  ...
  'autosize:resized .js-chat-submit-input': function (e) {
    const tmpl = Template.instance();
    const messages = tmpl.$('.js-chat-messages');
